...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#050505] text-white pt-16 pb-8 border-t border-white/5 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-12 mb-12">
          
          {/* Brand & Newsletter */}
          <div className="lg:col-span-5 flex flex-col justify-between">
            <div>
              <span className="text-4xl md:text-5xl font-black tracking-tighter text-white mb-6 block">
                Tiqsey<span className="text-brand">.</span>
              </span>
              <p className="text-gray-400 text-lg font-medium leading-relaxed max-w-sm mb-6">
          ...
          {/* Links block */}
          <div className="lg:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-10 lg:gap-12 text-sm mt-8 lg:mt-0 lg:pl-16">
            <div className="space-y-6">
              ...
              <ul className="space-y-3 font-semibold text-gray-400">
                <li><a href="#" className="hover:text-brand transition-colors">Destinations</a></li>
                <li><a href="#" className="hover:text-brand transition-colors">Activities</a></li>
        ...
        {/* Bottom bar */}
        <div className="flex flex-col border-t border-white/10 pt-6 md:flex-row justify-between items-center gap-8 text-xs font-bold text-gray-500">
