...
export const CURRENCIES: Currency[] = [
  ...
  { code: 'INR', name: 'Indian Rupee', symbol: 'Rs.', rate: 90 },
...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    navAttractionsAndTours: 'Attractions & Tours',
  ...
  fr: {
    ...
    navAttractionsAndTours: 'Attractions & Visites',
  ...
  de: {
    ...
    navAttractionsAndTours: 'Attraktionen & Touren',
    navGoCityPass: 'City Pass',
  ...
  es: {
    ...
    navAttractionsAndTours: 'Atracciones y Tours',
  ...
  it: {
    ...
    navAttractionsAndTours: 'Attrazioni e Tour',
    navGoCityPass: 'City Pass',
